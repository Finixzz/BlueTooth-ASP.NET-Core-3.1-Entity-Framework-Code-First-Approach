...
namespace BlueTooth.Migrations
{
    ...
    [Migration("20200604155203_AddedServiceMaterialsDbSet")]
    partial class AddedServiceMaterialsDbSet
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlueTooth.Models.Bill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("DentalCheckId");

                    b.ToTable("Bills");
                });

            modelBuilder.Entity("BlueTooth.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BlueTooth.Models.DentalCheck_Service", b =>
                {
                    b.Property<int>("DentalCheckID")
                        .HasColumnType("int");
                    ...
                    b.HasKey("DentalCheckID", "ServiceID");

                    b.HasIndex("ServiceID");

                    b.ToTable("DentalCheckServices");
                });
            ...
            modelBuilder.Entity("BlueTooth.Models.Matherial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Matherials");
                });

            modelBuilder.Entity("BlueTooth.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BlueTooth.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("VlasnikOrdinacijeId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("VlasnikOrdinacijeId");
            ...
            modelBuilder.Entity("BlueTooth.Models.Service_Materials", b =>
                {
                    b.Property<int>("ServiceId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ServiceId", "MatherialId");
            ...
            modelBuilder.Entity("BlueTooth.Models.Bill", b =>
                {
                    b.HasOne("BlueTooth.Models.DentalCheckUp", "DentalCheck")
                        .WithMany()
                        .HasForeignKey("DentalCheckId")
            ...
            modelBuilder.Entity("BlueTooth.Models.DentalCheck_Service", b =>
                {
                    ...
                    b.HasOne("BlueTooth.Models.Service", "Service")
                        .WithMany()
            ...
            modelBuilder.Entity("BlueTooth.Models.Matherial", b =>
                {
                    b.HasOne("BlueTooth.Models.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("BlueTooth.Models.OrderDetail", b =>
                {
                    b.HasOne("BlueTooth.Models.Matherial", "Matherial")
                        .WithMany()
                        .HasForeignKey("MatherialId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlueTooth.Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("BlueTooth.Models.OrderHeader", b =>
                {
                    b.HasOne("BlueTooth.Models.Firma", "Firma")
                        .WithMany()
                        .HasForeignKey("FirmaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlueTooth.Models.ApplicationUser", "VlasnikOrdinacije")
                        .WithMany()
                        .HasForeignKey("VlasnikOrdinacijeId");
                });

            modelBuilder.Entity("BlueTooth.Models.Rating", b =>
                {
                    b.HasOne("BlueTooth.Models.ApplicationUser", "User")
                        .WithMany()
